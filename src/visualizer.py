...
def plot_ring_state(attractor: RingAttractor, cmap: str = "viridis"):
    ...
    ax.bar(attractor.neuron_angles, height=1, width=width, bottom=0.5, color=colors, edgecolor="none")
    ax.set_yticks([])
